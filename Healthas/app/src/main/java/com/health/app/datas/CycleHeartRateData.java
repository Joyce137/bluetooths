 ...
 */
public class CycleHeartRateData extends Data{
    ...
    public static CycleHeartRateData toData(byte[] dataBytes){
        CycleHeartRateData data = new CycleHeartRateData();
