...
public abstract class TableOperate {
	...
	private final String TAG = "TableOperate";

	private static void setTabIndicator(TabSpec spec, String title,
	...
	public static void OnTabChanged(String tabId, TabWidget mTabWidget,
