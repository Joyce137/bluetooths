...
public class SleepMode {
    ...
    public boolean testConnect(){
        ...
        if(!SampleGattAttributes.connectedState) {
            if (!DeviceControlService.mBluetoothLeService.connect(BleInfo.mDeviceAddress)) {
    ...
    public void openSleepMode(){
        ...
        DeviceControlService.mBluetoothLeService.writeMessage(UUID.fromString(SampleGattAttributes.HEARTRATEPERIODRW), p);////写入
