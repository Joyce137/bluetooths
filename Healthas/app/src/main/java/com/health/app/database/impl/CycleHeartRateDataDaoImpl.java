...
import com.health.app.database.entity.CycleHeartRateDataEntity;
 ...
 */
public class CycleHeartRateDataDaoImpl extends DaoSupportImpl<CycleHeartRateDataEntity> {
...
//    private String userName;
    ...
    public boolean insertBleData(String address, String size, String data1, String data2,
        ...
        CycleHeartRateDataEntity scanBleData = new CycleHeartRateDataEntity();
