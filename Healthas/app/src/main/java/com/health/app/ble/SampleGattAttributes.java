...
public class SampleGattAttributes {
     ...
     */
    public static boolean sleepmode_checkflag = false;
    public static boolean timesync_checkflag = false;
    public static boolean xinlv_checkflag=false;
    public static boolean stepstest_checkflag=false;
    public static boolean autoheartratetest_checkflag=false;
    public static boolean nightheartratetest_checkflag=false;
     ...
     * write数据，控制数据
     */
    public static String controlStatus_Write = "00008001-0000-1000-8000-00805f9b34fb";//两字节的广播周期20~300ms

    /**
     * 特性句柄由BluetoothGattCharacteristic类代表
     * 发送数据的特性uuid
     */
    public static String broadcastperiodRW = "00008002-0000-1000-8000-00805f9b34fb";//两字节的广播周期20~300ms
    public static String broadcastTimeRW = "00008003-0000-1000-8000-00805f9b34fb";//2byte每次唤醒起来广播间隔，参数范围为：1000-30000ms，默认为 8000ms
    ...
    public static String HEARTRATEPERIODRW = "00008006-0000-1000-8000-00805f9b34fb";//2byte设置每天心率采集的次数，参数范围为：1-288 次，默认为 5
    ...
    public static String sendPowerRW = "00008009-0000-1000-8000-00805f9b34fb";//功率，x db=10log（10的x次幂）mw 所以0db为1mw那个log以10为底,默认为3
    public static String heartRateMaxMinQ = "0000800a-0000-1000-8000-00805f9b34fb";//心率上下限及靶心率Q参数
    //格式：3byte，byte1设置心率上限，默认为50，byte2设置心率下限，默认值为130，byte3设置Q参数，默认为100
...
//        characteristic.setWriteType(BluetoothGattCharacteristic.PROPERTY_NOTIFY);//这句话实际写的是descriptor字段
        boolean notifySuccess =  gatt.setCharacteristicNotification(characteristic, true);//理解为设立某characteristic，对其字段改变进行通知，连接开始时为空
        if(!notifySuccess)
            return false;
