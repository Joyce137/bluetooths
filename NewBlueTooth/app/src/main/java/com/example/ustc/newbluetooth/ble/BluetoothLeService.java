...
import com.example.ustc.newbluetooth.MainActivity;
...
public class BluetoothLeService extends Service {
    ...
    public void weilianjie(){
        Intent intent = new Intent("com.example.ustc.newbluetooth.ble.MY_BROADCAST02");
        sendBroadcast(intent);
        ...
        public void onLeScan(final BluetoothDevice device, int rssi, final byte[] scanRecord) {
          ...
          /*  if (device.getAddress().equals(device_name))
            ...
            if (device.getAddress().equals(device_name)) {
                scanLeDevice(false);
                //Toast显示已经扫描到设备
                Intent intent = new Intent("com.example.ustc.newbluetooth.ble.MY_BROADCAST01");
                sendBroadcast(intent);
