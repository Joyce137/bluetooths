...
public class DeviceControlService extends Service {
    ...
    public boolean isRegisterDeviceControlService = false;
   ...
   // public static String mDeviceAddress;
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            isRegisterDeviceControlService = true;
        }
...
//目前处理不了自动锁屏，主动的没事
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (flag2 && flag3) {
                    ...
                    if(SampleGattAttributes.controlbroadcast==3)
                        if(mBluetoothLeService != null)
                            mBluetoothLeService.weilianjie();
                    if(mBluetoothLeService != null)
    ...
    public void onDestroy() {
        ...
        if(isRegisterDeviceControlService)
//        if(MainActivity.isBindServiceConnection)
