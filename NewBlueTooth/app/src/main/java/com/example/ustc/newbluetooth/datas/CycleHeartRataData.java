 ...
 */
public class CycleHeartRataData extends Data{
    ...
    public static CycleHeartRataData toData(byte[] dataBytes){
        CycleHeartRataData data = new CycleHeartRataData();
